        ...
        <div class="col-md-9">
            ...
            <div class="panel panel-info">
                ...
                <div class='panel-info panel-description'>
                    ...
                    @if($is_admin)
                    <p>You are admin,
                        <a href="{!! URL::route('Myclass.list',['user_id' => $user_id]) !!}">click here</a> to view your created rules
                    </p>
                    @endif
                </div>
                <!--/DESCRIPTION-->
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(['route'=>['Myclass.delete', 'id' => @$item->id], 'method' => 'get']) !!}

                    @include('Myclass::admin.myclass-item')
