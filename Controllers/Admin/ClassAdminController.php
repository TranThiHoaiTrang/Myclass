<?php namespace Tranthihoaitrang\Myclass\Controllers\Admin;
...
class ClassAdminController extends FooController {
    ...
    public function __construct(Request $request) {
        ...
        $this->category_ref_name = 'admin/Myclass';
        ...
        $this->breadcrumb_2['label'] = 'Myclass';
    ...
    public function config(Request $request) {
        ...
        $is_valid_request = $this->isValidRequest($request);
        // display view
        $config_path = realpath(base_path('config/Myclass.php'));
        // $package_path = realpath(base_path('vendor/foostart/package-classes'));
        $package_path = realpath(base_path('vendor/Tranthihoaitrang/Myclass'));
